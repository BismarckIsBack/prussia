...
countries.forEach(path => {
  ...
  const territory = document.querySelectorAll(`.tara.${countryId}`);
  ...
  path.addEventListener('click', () => {
    if(crtStat) {
      const prevTerritory = document.querySelectorAll(`.tara.${crtStat}`);
      prevTerritory.forEach(p => p.classList.remove('selectat'));
    }  
    territory.forEach(p => p.classList.add('selectat'));
    crtStat = countryId;  
  });
});
...
const info = {
  ...
  LIB: {
    denumire: 'Liberia',
    steag: 'imagini/steaguri/liberia.png',
    alianta: 'Antanta',
    populatie: '~1,2 milioane',
    victime: '0',
    particip: '1917-1918'
  },
  ED: {
    denumire: 'Ecuador',
    steag: 'imagini/steaguri/ecuador.png',
    alianta: 'Țară neutră',
    populatie: '1,78 milioane',
    victime: '0',
    particip: ''
  },
  PRU: {
    denumire: 'Peru',
    steag: 'imagini/steaguri/peru.png',
    alianta: 'Țară neutră',
    populatie: '~4,5 milioane',
    victime: '0',
    particip: ''
  },
  BOL: {
    denumire: 'Bolivia',
    steag: 'imagini/steaguri/bolivia.png',
    alianta: 'Țară neutră',
    populatie: '~2,5 milioane',
    victime: '0',
    particip: ''
  ...
  PRY: {
    denumire: 'Paraguay',
    steag: 'imagini/steaguri/paraguay.png',
    alianta: 'Țară neutră',
    populatie: '~650.000',
    victime: '0',
    particip: ''
  ...
  ARG: {
    denumire: 'Argentina',
    steag: 'imagini/steaguri/argentina.png',
    alianta: 'Țară neutră',
    populatie: '7,85 milioane',
    victime: '0',
    particip: ''
  },
  URY: {
    denumire: 'Uruguay',
    steag: 'imagini/steaguri/uruguay.png',
    alianta: 'Țară neutră',
    populatie: '~1,27 milioane',
    victime: '0',
    particip: ''
  },
  CHL: {
    denumire: 'Chile',
    steag: 'imagini/steaguri/chile.png',
    alianta: 'Țară neutră',
    populatie: '~3,11 milioane',
    victime: '0',
    particip: ''
  },
  ESV: {
    denumire: 'El Salvador',
    steag: 'imagini/steaguri/salvador.png',
    alianta: 'Țară neutră',
    populatie: '~1 milion',
    victime: '0',
    particip: ''
  ...
  GUA: {
    denumire: 'Guatemala',
    steag: 'imagini/steaguri/guatemala.png',
    alianta: 'Țară neutră',
    populatie: '~1,5 milioane',
    victime: '0',
    particip: ''
  },
  MEX: {
  ...
  BRA: {
    denumire: 'Brazilia',
    steag: 'imagini/steaguri/brazilia.png',
    alianta: 'Antanta',
    populatie: '25 de milioane',
    victime: '0',
    particip: '1917-1918'
  },
  PA: {
    denumire: 'Panama',
    steag: 'imagini/steaguri/panama.png',
    alianta: 'Antanta',
    populatie: '~400.000',
    victime: '0',
    particip: '1917-1918'
  ...
  NIC: {
    denumire: 'Nicaragua',
    steag: 'imagini/steaguri/nicaragua.png',
    alianta: 'Antanta',
    populatie: '~600.000',
    victime: '0',
    particip: '1918'
  ...
  CR: {
    denumire: 'Costa Rica',
    steag: 'imagini/steaguri/costa.png',
    alianta: 'Antanta',
    populatie: '~300.000',
    victime: '0',
    particip: '1918'
  ...
  HON: {
    denumire: 'Honduras',
    steag: 'imagini/steaguri/honduras.png',
    alianta: 'Antanta',
    populatie: '~500.000',
    victime: '0',
    particip: '1918'
  ...
  CU: {
    denumire: 'Cuba',
    steag: 'imagini/steaguri/cuba.png',
    alianta: 'Antanta',
    populatie: '~2 milioane',
    victime: '0',
    particip: '1917-1918'
  },
  HAT: {
    denumire: 'Haiti',
    steag: 'imagini/steaguri/haiti.png',
    alianta: 'Antanta',
    populatie: '~1,5 milioane',
    victime: '0',
    particip: '1918'
  ...
  SM: {
    denumire: 'San Marino',
    steag: 'imagini/steaguri/marino.png',
    alianta: 'Țară neutră',
    populatie: '~15.000',
    victime: '0',
    particip: ''
  ...
  MO: {
    denumire: 'Monaco',
    steag: 'imagini/steaguri/monaco.png',
    alianta: 'Țară neutră',
    populatie: '~25.000',
    victime: '0',
    particip: ''
  ...
  LXM: {
    denumire: 'Luxemburg',
    steag: 'imagini/steaguri/luxemburg.png',
    alianta: 'Antanta',
    populatie: '~250.000',
    victime: '300',
    particip: '1914-1918'
  ...
  LCH: {
    denumire: 'Liechtenstein',
    steag: 'imagini/steaguri/liechtenstein.png',
    alianta: 'Țară neutră',
    populatie: '~12.000',
    victime: '0',
    particip: ''
  ...
  AND: {
    denumire: 'Andorra',
    steag: 'imagini/steaguri/andorra.png',
    alianta: 'Țară neutră',
    populatie: '~5.000',
    victime: '0',
    particip: ''
  ...
  CHI: {
      denumire: 'China',
      steag: 'imagini/steaguri/china.png',
      alianta: 'Antanta',
      populatie: '400 de milioane',
      victime: '~6.500',
      particip: '1917-1918'
  }
};
...
countries.forEach(path => {
    path.addEventListener("click", () => {
      ...
      exit.addEventListener("click", () => {
        infoBox.remove();
        const territory = document.querySelectorAll(`.tara.${countryId}`);
        territory.forEach(p => p.classList.remove('selectat'));
      });   
